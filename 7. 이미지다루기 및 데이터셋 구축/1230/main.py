...
def main(opt) :
    ...
    # def train(n_epochs, train_loader, val_loader, model, optimizer, criterion, device, save_path, lass_validation_loss =None):
    train(opt.epoch, train_loader, val_loader, net, optimizer, criterion, device, save_dir , scheduler)


def parse_opt() : # 파라미터 설정해주는 함수
